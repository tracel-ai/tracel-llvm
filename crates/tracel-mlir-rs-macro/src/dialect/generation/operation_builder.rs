...
pub fn generate_operation_builder(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        ...
        pub struct #identifier<'c, #(#type_parameters),*> {
            builder: ::mlir_rs::ir::operation::OperationBuilder<'c>,
            context: &'c ::mlir_rs::Context,
...
fn generate_field_fn(builder: &OperationBuilder, field: &impl OperationField) -> TokenStream {
    ...
    // Argument types can be singular and variadic. But `add` functions in mlir_rs
...
fn generate_new_fn(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        impl<'c> #identifier<'c, #(#arguments),*> {
            pub fn new(context: &'c ::mlir_rs::Context, location: ::mlir_rs::ir::Location<'c>) -> Self {
                Self {
                    context,
                    builder: ::mlir_rs::ir::operation::OperationBuilder::new(#name, location),
                    _state: Default::default(),
                }
            }
        }
...
pub fn generate_operation_builder_fn(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        ...
        pub fn builder(
            context: &'c ::mlir_rs::Context,
            location: ::mlir_rs::ir::Location<'c>
...
pub fn generate_default_constructor(builder: &OperationBuilder) -> TokenStream {
    ...
    let arguments = builder
        ...
        .chain([quote! { location: ::mlir_rs::ir::Location<'c> }])
        .collect::<Vec<_>>();
    ...
    quote! {
        ...
        #[doc = #doc]
        pub fn #constructor_identifier<'c>(context: &'c ::mlir_rs::Context, #(#arguments),*) -> #operation_identifier<'c> {

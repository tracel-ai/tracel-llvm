...
pub fn generate_operation(operation: &Operation) -> TokenStream {
    ...
    quote! {
        ...
        pub struct #identifier<'c> {
            operation: ::mlir_rs::ir::operation::Operation<'c>,
        }
        ...
        impl<'c> #identifier<'c> {
            ...
            pub fn as_operation(&self) -> &::mlir_rs::ir::operation::Operation<'c> {
                &self.operation
            }
        ...
        impl<'c> TryFrom<::mlir_rs::ir::operation::Operation<'c>> for #identifier<'c> {
            type Error = ::mlir_rs::Error;
        ...
        impl<'c> From<#identifier<'c>> for ::mlir_rs::ir::operation::Operation<'c> {

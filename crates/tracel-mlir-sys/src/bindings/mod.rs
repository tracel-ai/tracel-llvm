...
#[cfg(all(not(feature = "xtask"), all(target_os = "linux", target_arch = "aarch64")))]
mod bindings_linux_aarch64;

#[cfg(all(not(feature = "xtask"), all(target_os = "linux", target_arch = "aarch64")))]
pub use bindings_linux_aarch64::*;

#[cfg(all(not(feature = "xtask"), all(target_os = "linux", target_arch = "x86_64")))]
mod bindings_linux_x86_64;

#[cfg(all(not(feature = "xtask"), all(target_os = "linux", target_arch = "x86_64")))]
pub use bindings_linux_x86_64::*;

#[cfg(all(not(feature = "xtask"), all(target_os = "macos", target_arch = "aarch64")))]
mod bindings_macos_aarch64;

#[cfg(all(not(feature = "xtask"), all(target_os = "macos", target_arch = "aarch64")))]
pub use bindings_macos_aarch64::*;

#[cfg(all(not(feature = "xtask"), all(target_os = "windows", target_arch = "x86_64")))]
